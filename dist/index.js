...
const run = async () => {
    ...
    const getGreaterThanThresholdEmoji = (coverage, threshold) => coverage >= threshold ? ":white_check_mark:" : ":fire:";
    const getLessThanThresholdEmoji = (coverage, threshold) => coverage <= threshold ? ":white_check_mark:" : ":fire:";
